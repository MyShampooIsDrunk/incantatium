...
//    }
//
//    public static class SolidHitboxEntity extends AbstractHitboxEntity<ArmorStandEntity> {
//        private SolidHitboxEntity(float sizeMultiplier) {
//            super(EntityType.ARMOR_STAND, "block_hitbox", sizeMultiplier);
//        }
//
//        private SolidHitboxEntity() {
//            this(1);
//        }
//
//        @Override
//        public ArmorStandEntity create(ServerWorld world, MultiblockStructure structure, BlockPos center, Vec3d relative) {
//            ArmorStandEntity entity = super.create(world, structure, center, relative.add(0.5,-1.975,0.5));
//            ShulkerEntity shulker = EntityType.SHULKER.create(world, SpawnReason.MOB_SUMMONED);
...
//            shulker.startRiding(entity, true);
//            shulker.addStatusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, -1, 0, false, false));
////            shulker.getAttributes().addPersistentModifiersFrom(new AttributeContainer(DefaultAttributeContainer.builder()
////                    .add(EntityAttributes.SCALE,getSizeMultiplier()).build()));
//            Objects.requireNonNull(shulker.getAttributes().getCustomInstance(EntityAttributes.SCALE)).setBaseValue(this.getSizeMultiplier());
//            shulker.setYaw(0.0F);
//            shulker.headYaw = shulker.getYaw();
//            shulker.resetPosition();
//            return entity;
//        }
//
//        @Override
//        public void onDiscard(Entity me) {
//            System.out.println("tryna discard fr fr");
//            Entity e;
//            if ((e = me.getFirstPassenger()) != null) e.discard();
//            super.onDiscard(me);
//        }
//    }
//
